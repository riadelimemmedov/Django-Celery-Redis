...
SECRET_KEY = 'django-insecure-lk$e80q72@nmh6#v3necp3p89^#u%1vi&fqp6^ds)w06o8-01q'
...
#django_celery_results not showed admin panel,but django_celery_beat showing at admin panel as Periodic Tasks
...
EMAIL_HOST_PASSWORD ='oinkjumckqhxxlxe'
DEFAULT_FROM_EMAIL = 'Celery <riadalimammedovriad@gmail.com>'

#!Celery and Redis Command For Starting Server
#Celery => celery -A django_celery_project.celery worker --pool=solo -l info
#Redis => celery -A django_celery_project beat -l info
